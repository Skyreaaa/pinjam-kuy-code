...
const { upload, cloudinaryProcessor } = require('../middleware/upload');
router.post('/ready-to-return/:id', upload.single('proofPhoto'), cloudinaryProcessor, loanController.markAsReadyToReturn); 
