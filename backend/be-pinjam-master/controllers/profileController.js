...
const { upload, cloudinaryProcessor, useCloudinary } = require('../middleware/upload'); 
...
exports.uploadPhoto = [
    ...
    async (req, res) => {
        ...
        const newPhotoPath = useCloudinary && req.file.cloudinaryUrl
        ...
        try {
            ...
            if (result.affectedRows > 0 && oldPhotoUrl && !oldPhotoUrl.startsWith('http')) {
